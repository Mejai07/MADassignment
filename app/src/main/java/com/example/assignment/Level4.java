...
public class Level4 extends AppCompatActivity {
    ...
    private long mTimeLeftInMillis = 10000;//start with 10 seconds
    ...
    private void Change() {
        levelChange = new CountDownTimer(5000, 1000) {
            ...
            public void onFinish() {
                ...
                Intent level5 = new Intent(Level4.this, Level5.class);//change to level2
                level5.putExtra("score", score);
