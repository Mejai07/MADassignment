...
public class Level3 extends AppCompatActivity {
    ...
    private long mTimeLeftInMillis = 15000;//start with 15 seconds
    ...
    private void Change() {
        levelChange = new CountDownTimer(5000, 1000) {
            ...
            public void onFinish() {
                ...
                Intent level4 = new Intent(Level3.this, Level4.class);//change to level2
                level4.putExtra("score", score);
